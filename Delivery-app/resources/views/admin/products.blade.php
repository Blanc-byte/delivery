<x-app-layout>
                                ...
                                <tr>
                                    ...
                                    <td class="flex space-x-2">
                                        <a href="#" class="button button-blue"
                                           onclick="event.preventDefault(); openEditModal({{ $product->id }}, '{{ $product->name }}', '{{ $product->description }}', {{ $product->price }}, '{{ $product->category }}')">
                                            Edit
                                        </a>
                                        <!-- Remove Button -->
    ...
    <div id="confirmation-modal" class="modal-overlay hidden">
        <div class="modal-content">
            <h2 class="text-xl font-bold mb-4">Are you sure you want to remove this product?</h2>
